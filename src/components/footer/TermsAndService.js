...
const TermsAndService = () => {
  return (
    <div className="terms-container">
      ...
      <p>
        We reserve the right to update these terms and conditions at any time. Your continued use of the website following any changes indicates your acceptance of the new terms.
      </p>
      <h2>Governing Law</h2>
      <p>
